...
const Header = () => {
  return (
    ...
    w-full overflow-hidden md:flex-nowrap' style={{backgroundImage: `url(${img_1})`}}>
        <Navbar/>            
      <div className='container w-full text-left px-4 md:px-30 mt-50 md:mt-40'>
      <h2 className=" font-high text-4xl text-white leading-30 md:text-7xl font-normal">AbiaTours</h2>
        <p className="font-secondary w-full font-normal text-xl text-white md:text-xl
        ">Discover your utimate holidays vibe through Abia's amazing tours,
          shopping entertainment and attractions
        </p> 
        <div className="mt-4 md:mt-9">
                  <a href="" className="bg-yellow-300 rounded-xl px-4 py-3 border-0 text-white md:px-8 ">Discover more</a>
        </div>
      </div>
      <div className="mt-20 md:mt-64">
        ...
        <div className="relative flex-shrink-0 overflow_hidden flex gap-2 transition-transform duration-500 ease-in-out w-full ml-24 mb-20 md:ml-4">
          ...
          <p className="text-white text-xm flex items-center justify-center">Azumini Blue River</p>
          </div>
